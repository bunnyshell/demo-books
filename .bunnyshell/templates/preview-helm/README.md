...
The template provides the Bunnyshell configuration composed of 5 Components (frontend + backend + database and the container images for frontend and backend) and the CRUD application that demonstrates how the components work together to form an environment.
